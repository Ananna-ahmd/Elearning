        ...
        <div class="col-md-4">    
            ...
            <form role="form" id="stuLoginForm">
                <div class="form-group">
                    <i class="fas fa-envelope"></i><label for="teacherLogEmail" class="pl-2 font-weight-bold">Email</label><input type="email" class="form-control" placeholder="Email" name="teacherLogEmail" id="teacherLogEmail">
                </div>
                <div class="form-group">
                    <i class="fas fa-key"></i><label for="teacherLogPass" class="pl-2 font-weight-bold">Password</label><input type="password" class="form-control" placeholder="Password" name="teacherLogPass" id="teacherLogPass">
                </div>
